...
class PostTest(TestCase):
    ...
    def test_update_method(self):
        ...
        self.assertEqual(post.post_title, "New Title")
        self.assertEqual(post.post_text, "New Text")
    ...
    def test_post_attributes(self):
        ...
        self.assertEqual(post.post_code, 5)
        self.assertEqual(post.post_title, "Test Title")
        self.assertEqual(post.post_text, "Test Content")
